...
\subtitle{MH 88 (74)\\(D-Mbs Mus.ms. 450 (449))}
\scoring{2 S, A, T, B (solo), S, A, T, B (coro), 2 clno, timp, 2 vl, b, org}
\maketitle
...
This edition bases upon the autograph manuscripts in the Bayerische Staatsbibliothek München. The digital versions of the manuscripts are available at \url{https://mdz-nbn-resolving.de/urn:nbn:de:bvb:12-bsb00084984-1} (MH 88, siglum Mus.ms. 450; see also RISM ID 456009470) and \url{http://mdz-nbn-resolving.de/urn:nbn:de:bvb:12-bsb00002140-1} (MH 74, siglum Mus.ms. 449; see also RISM ID 456009469). Moreover, a copy of MH 88 is available from the Musikarchiv Spitz, \url{https://mirador.acdh.oeaw.ac.at/musikarchivspitz/A-SPD_H19/} (siglum A-SPD SP (H-19); see also RISM ID 455042304).
...
\begin{longtable}{lll L{10cm}}
  ...
  \midrule \endhead
  2 & – & – & Only the first bar of this movement appears in the MH 88 Ms. Haydn indicated that the corresponding movement should be reused from the MH 74 Ms, with T singing the first solo instead of S1. (Likely, the second solo remained with A, since the copy in A-SPD contains an A solo.) \\
  3 & 28 & S 2 & 2nd/3rd eighth in Ms: b′8–c″8 (adapted to S 1 to allow for a single S tutti) \\
    & 43 & S 2 & 3rd quarter in Ms: c″8–c″8 (see above) \\
  4 & 57 & T   & bar in Ms: r8–d′8–d′8–d′8 \\
  5 & –  & –   & bars 1–38 reused from the MH 74 Ms \\
  \bottomrule
\end{longtable}


This edition has been compiled and checked with utmost diligence. Nevertheless, errors and mistakes cannot be totally excluded. Please report any errors and mistakes to \url{wolfgang@esser-skala.at} or create an issue or pull request on the edition’s GitHub page \url{https://github.com/skafdasschaf/haydn-m-litaniae-lauretanae-MH-88_74}. Your help will be greatly appreciated.
